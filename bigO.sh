...
sleep 1
export data="SERVER HAD PLACED THE TRADE ON USER: $i , APP=OLYMP TRADE , ASSET=$a , TIME=$t SUBSCRIPTION STATUS= $n / $p LEFT ! WAITING FOR RESULT OF TRADE FOR USER: $i , INITIAL BALANCE $amt USD CURRENT BAL $aftr USD .want to Automate your tradeing ? link your tradeing account at http://www.Algotradeing.com "
...
$(pwd)/xh "https://api.telegram.org/bot5234920052:AAEDxAVyUMHE5p_t1FwhC3HRUC9FycEz_Tc/sendMessage?chat_id=@algo_Tradeing&text=$data2"
...
$(pwd)/xh "https://api.telegram.org/bot5234920052:AAEDxAVyUMHE5p_t1FwhC3HRUC9FycEz_Tc/sendMessage?chat_id=@algo_Tradeing&parse_mode=markdownv2&text=||$data3||"
sleep 1
export data="SERVER HAD PLACED THE TRADE ON USER: $i , APP=OLYMP TRADE , ASSET=$a , TIME=$t SUBSCRIPTION STATUS= $n / $p LEFT ! WAITING FOR RESULT OF TRADE FOR USER: $i  .want to Automate your tradeing ? link your tradeing account at http://www.Algotradeing.com "
$(pwd)/xh "https://api.telegram.org/bot5234920052:AAEDxAVyUMHE5p_t1FwhC3HRUC9FycEz_Tc/sendMessage?chat_id=@algo_Tradeing&text=$data"
export data4="SERVER IS WAITNG FOR TRADE TO BE COMPLETED FOR USER $i "
sleep 2
$(pwd)/xh "https://api.telegram.org/bot5234920052:AAEDxAVyUMHE5p_t1FwhC3HRUC9FycEz_Tc/sendMessage?chat_id=@algo_Tradeing&text=$data4"
sleep 59
export aftr=$(echo $aftr $inc | awk '{print $1 }')
