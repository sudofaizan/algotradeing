...
export data3="MACHINE LEARNING ALGORITHM IS LEARNING MARKET OF $a SERVER IS WAITING FOR ANALYSIS TO COMPLETE"
...
export data4="SERVER IS WAITNG FOR ML-ALGORITHM TO ORDER A TRADE "
=======
